...
private:
    ...
    explicit SpeechSynthesizer(SPXSYNTHHANDLE hsynth) :
        ...
        VisemeReceived(GetVisemeEventConnectionsChangedCallback(), GetVisemeEventConnectionsChangedCallback(), false),
        BookmarkReached(GetBookmarkEventConnectionsChangedCallback(), GetBookmarkEventConnectionsChangedCallback(), false)
    {
        SPX_DBG_TRACE_SCOPE(__FUNCTION__, __FUNCTION__);
    }
